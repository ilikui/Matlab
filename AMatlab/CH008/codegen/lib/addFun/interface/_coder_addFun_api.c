 ...
 * Return Type  : void
 */
void addFun_api(const mxArray * const prhs[2], const mxArray *plhs[2])
{
  int32_T a;
  int32_T b;
  int32_T c;
...
/*
 * File trailer for _coder_addFun_api.c
 *
 * [EOF]
 */
